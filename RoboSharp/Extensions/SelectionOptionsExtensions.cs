...
namespace RoboSharp.Extensions
{
    ...
    public static partial class SelectionOptionsExtensions
    {
        ...
        public static bool ShouldExcludeOlder(this SelectionOptions options, string source, string destination) => options.ExcludeOlder && FilePairExtensions.IsDestinationNewer(source, destination);
        
        /// <inheritdoc cref="ShouldExcludeOlder(SelectionOptions, string, string)"/>
        public static bool ShouldExcludeOlder(this SelectionOptions options, FileInfo source, FileInfo destination) => options.ExcludeOlder && FilePairExtensions.IsDestinationNewer(source, destination);
        ...
        /// <summary> </summary>
        /// <returns> TRUE if the file should be excluded, FALSE if it should be included </returns>
        public static bool ShouldExcludeNewer(this SelectionOptions options, string source, string destination) => options.ExcludeNewer && FilePairExtensions.IsSourceNewer(source, destination);
        
        /// <inheritdoc cref="ShouldExcludeNewer(SelectionOptions, string, string)"/>
        public static bool ShouldExcludeNewer(this SelectionOptions options, FileInfo source, FileInfo destination) => options.ExcludeNewer && FilePairExtensions.IsSourceNewer(source, destination);
        ...
        /// <inheritdoc cref="ShouldExcludeFileName(SelectionOptions, string, ref Regex[])"/>
        public static bool ShouldExcludeFileName(this SelectionOptions options, IFilePair pair, ref Regex[] exclusionCollection) => ShouldExcludeFileName(options, pair.Source.Name, ref exclusionCollection);
        ...
        /// <inheritdoc cref="ShouldExcludeDirectoryName(SelectionOptions, string, ref Tuple{bool, Regex}[])"/>
        public static bool ShouldExcludeDirectoryName(this SelectionOptions options, IDirectoryPair pair, ref Tuple<bool, Regex>[] exclusionCollection) => ShouldExcludeDirectoryName(options, pair.Source.FullName, ref exclusionCollection);
